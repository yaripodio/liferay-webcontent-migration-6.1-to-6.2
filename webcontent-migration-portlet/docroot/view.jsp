...
<portlet:actionURL name="checkAction" var="checkURL" />
<input value="Check all structures without changing anything" type="button" onclick="document.location.href='<%= checkURL %>';" />
&nbsp;&nbsp;&nbsp;
<portlet:actionURL name="checkAllAction" var="checkAllURL" />
<input value="Check all structures and related contents without changing anything" type="button" onclick="document.location.href='<%= checkAllURL %>';" />
&nbsp;&nbsp;&nbsp;
<portlet:actionURL name="runAction" var="runURL" />
<input value="Run the full migration process" type="button" onclick="document.location.href='<%= runURL %>';" />
<%

String output = request.getParameter("PROCESS_OUTPUT");
